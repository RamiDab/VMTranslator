...
class Parser:
    ...
    def has_more_commands(self) -> bool:
        ...
        """
        # Your code goes here!
        return self.counter < self.numoflines
    ...
    def command_type(self) -> str:
        ...
        """
        # Your code goes here!
        current_line_split = self.lines[self.counter].split()[0]

        return self.COMMAND_MAP[current_line_split]
    ...
    def arg1(self) -> str:
        ...
        if self.command_type() == "C_ARITHMETIC":
            ...
            return self.lines[self.counter].split(" ")[1]
    ...
    def arg2(self) -> int:
        ...
        return int(self.lines[self.counter].split(" ")[2])
